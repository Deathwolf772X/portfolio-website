      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mg-6 lg:text-xl">
            Training Fullstack Web Developer
          </p>
          <div>
            ...
            <button className="px-1 py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-yellow-500 via-primary-500 to secondary-500 hover:bg-slate-800 text-white mt-3">
